...
public class Quests {
    ...
    public List<String> convertQuestPlaceholders(List<String> lore, Player p, Enum questType, int questID){
        ...
        int progressBarAmount = SkyBlock.getInstance().getFileManager().getQuestFile().fetchInt("placeholder.progressBar-count");
    ...
    public FileConfiguration getConfig(Enum questType){
        if (questType.equals(Quest.QuestType.DAILY)) {
            return SkyBlock.getInstance().getFileManager().getDailyQuestFile().getConfig();
        }
        if (questType.equals(Quest.QuestType.FOREVER)) {
            return SkyBlock.getInstance().getFileManager().getForeverQuestFile().getConfig();
        }
        if (questType.equals(Quest.QuestType.WEEKLY)) {
            return SkyBlock.getInstance().getFileManager().getWeeklyQuestFile().getConfig();
        }
        if (questType.equals(Quest.QuestType.MONTHLY)) {
            return SkyBlock.getInstance().getFileManager().getMonthlyQuestFile().getConfig();
        }
        return null;
    }
