...
public enum Version {
    ...
    private static final String rawVersionString;
    private static Version currentVersion;
    private static Version latest;

    static {
        rawVersionString = Bukkit.getServer().getClass().getPackage().getName().split("\\.")[3];
    }
    ...
    public static String getRawVersionString() {
