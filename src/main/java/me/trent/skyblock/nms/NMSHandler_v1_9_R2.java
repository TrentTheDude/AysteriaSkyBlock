...
public class NMSHandler_v1_9_R2 extends NMSHandler {
    ...
    public void calculate(Chunk chunk, Island island) {
        ...
        for (final Map.Entry<BlockPosition, TileEntity> entry : craftChunk.getHandle().tileEntities.entrySet()) {
            if (island.isBlockInIsland(entry.getKey().getX(), entry.getKey().getZ())) {
                ...
                if (tileEntity instanceof net.minecraft.server.v1_9_R2.TileEntityMobSpawner) {
                    net.minecraft.server.v1_9_R2.TileEntityMobSpawner spawner = (net.minecraft.server.v1_9_R2.TileEntityMobSpawner)tileEntity;
    ...
    public void sendBorder(Player p, double x, double z, double radius) {
        ...
        org.bukkit.craftbukkit.v1_9_R2.CraftWorld craftWorld = (CraftWorld) bukkitWorld;
