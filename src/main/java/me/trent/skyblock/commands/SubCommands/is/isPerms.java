...
public class isPerms extends SubCommand {

    public isPerms(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
