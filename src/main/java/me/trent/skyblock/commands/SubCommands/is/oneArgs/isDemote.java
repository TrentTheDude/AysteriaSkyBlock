...
public class isDemote extends SubCommand {

    public isDemote(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
