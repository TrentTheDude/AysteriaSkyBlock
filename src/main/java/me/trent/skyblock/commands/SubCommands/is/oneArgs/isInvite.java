...
public class isInvite extends SubCommand {

    public isInvite(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
