...
public class isPromote extends SubCommand {

    public isPromote(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
