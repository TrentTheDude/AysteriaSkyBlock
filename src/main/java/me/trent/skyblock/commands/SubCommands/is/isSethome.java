...
public class isSethome extends SubCommand {

    public isSethome(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
