...
public class isCreate extends SubCommand {

    public isCreate(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
