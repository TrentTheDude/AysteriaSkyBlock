...
public class isRules extends SubCommand {

    public isRules(CommandBase commandBase, String name, String description, String permission, String usageMessage, String... aliases){
